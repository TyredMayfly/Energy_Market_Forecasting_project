...
class TestForecastService:
    ...
    def test_get_model_key_selective_weather(self):
        ...
        key = service._get_model_key("intraday", "random_forest", config)
...
class TestWeatherFeatureSelection:
    ...
    def test_selective_weather_features(self, mock_env_vars, sample_market_data, sample_weather_data):
    ...
    def test_different_configs_different_cache(self, mock_env_vars, sample_market_data, sample_weather_data):
