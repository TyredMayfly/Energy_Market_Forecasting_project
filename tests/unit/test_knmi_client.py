...
def test_fetch_historical_for_2025():
    ...
    # Check date range (compare with timezone-aware datetimes)
    import pandas as pd
    assert df.index.min() >= pd.Timestamp("2024-10-01 01:00:00", tz="UTC")
    ...
    df = pd.DataFrame(
        {
            ...
            "timestamp": pd.to_datetime(
                ["2025-01-01 00:00", "2025-01-01 12:00", "2025-01-01 13:00"]
            ),
        }
    )
